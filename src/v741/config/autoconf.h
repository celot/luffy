...
#define CONFIG_USER_GOAHEAD_LANG_KOR 1
#define CONFIG_USER_GOAHEAD_LANG_JP 1
#define CONFIG_LIB_LIBNVRAM_FORCE 1
...
#define CONFIG_USER_PPPD_PPPSTATS 1
#undef  CONFIG_USER_PPPD_PPPDUMP
#define CONFIG_USER_PPPD_PPPCHAT 1
...
#define CONFIG_USER_IPROUTE2 1
#define CONFIG_USER_IPROUTE2_TC 1
#define CONFIG_RALINKAPP_SUPERDMZ 1
