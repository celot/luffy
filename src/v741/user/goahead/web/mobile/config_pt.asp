...
function initApn()
{
	...
	if(authtype=="" || (authtype!="PAP" && authtype!="CHAP" && authtype!="NONE")) authtype = "AUTO";
...
<script language = "JavaScript" type = "text/javascript"> printContentHead("config.asp"); </script>
	...
	<tr id="trAPN">
		...
		<td>
			...
			<option value="NONE" id="AuthNone">NONE</option>
	...
	<tr id="trAPN_d2">
		...
		<td>
			...
			<option value="NONE" id="AuthNone_d2">NONE</option>
