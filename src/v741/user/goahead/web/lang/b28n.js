...
function Butterlation() {
  ...
  this.getLang = function() {
    ...
    lang =  unescape(document.cookie.substring(one+9,end));	
    //return (lang.length>0)?lang:"en";	
    return (lang.length>0)?lang:"jp";	
  ...
  {   	
       this.domain = domain;
  	this.po=window.location.protocol+"//"+window.location.host+"/lang/"+this.lang+"/"+domain+".xml"; this.initializeDictionary(); 
  }
  this.getTextDomain = function()
  {
      return this.domain;
  }
