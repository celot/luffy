...
function printContentHead(now_file_name)
{
	...
	menu.add(600, 0, 'admin', "#", _("treeapp admin"));	
		...
		menu.add(608, 600, '',"/adm/kddi_ota.asp", _("treeapp kddi title"));
	...
	menu.add(700, 0, 'service', "#", _("treeapp service"));	
		...
		menu.add(704, 700, '',"/service/emg_notifier.asp", _("treeapp emg_notifier"));

		if("1" == menuMODBUS)
		{
			menu.add(705, 700, '',"/service/modbus.asp", _("treeapp modbus"));
		}
		if("1" == menuGPS)
		{
			menu.add(706, 700, '',"/service/gps_set.asp", _("treeapp gps function"));
		}
