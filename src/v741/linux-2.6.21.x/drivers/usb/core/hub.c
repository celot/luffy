...
#ifdef CONFIG_CELOT_GPIO //tyranno140325
static int celot_usb_run(void)
{
	u32 gpiomode;
	...
	gpiomode = le32_to_cpu(*(volatile u32 *)(0xB0000648));
	gpiomode &= ~0x800;
	mdelay (100);
	*(volatile u32 *)(0xB0000648) = cpu_to_le32(gpiomode);
	gpiomode |= 0x800;
	*(volatile u32 *)(0xB0000648) = cpu_to_le32(gpiomode);
